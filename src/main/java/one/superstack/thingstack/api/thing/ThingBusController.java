...
public class ThingBusController extends AuthenticatedThingController {
    ...
    public ThingBusPropertyChangeAckResponse ackPropertyChange(@PathVariable String propertyKey, @Valid @RequestBody ThingBusPropertyChangeAckRequest thingBusPropertyChangeAckRequest) {
    ...
    public ThingBusActionResultResponse setActionResult(@PathVariable String actionKey, @Valid @RequestBody ThingBusActionResultRequest thingBusActionResultRequest) {
    ...
    public ThingBusEmitEventResponse emitEvent(@PathVariable String eventKey, @Valid @RequestBody ThingBusEmitEventRequest thingBusEmitEventRequest) {
